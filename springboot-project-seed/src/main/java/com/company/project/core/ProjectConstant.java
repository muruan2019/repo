...
public final class ProjectConstant {
    ...
    /* ################################## 修改区开始 ########################################*/
    // 日志需要添加
    public static final String APP_NAME = "seed";
    public static final String SERVICE_NAME = "springboot-project-seed";
    public static final String COMMON_PACKAGE = "com.company";
    public static final String BASE_PACKAGE = COMMON_PACKAGE + ".project";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
